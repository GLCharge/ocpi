...
// checks if the TariffElementsRestrictions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TariffElementsRestrictions{}

// TariffElementsRestrictions struct for TariffElementsRestrictions
...
func NewTariffElementsRestrictions() *TariffElementsRestrictions {
	this := TariffElementsRestrictions{}
	return &this
}
...
func (o *TariffElementsRestrictions) GetReservation() ReservationRestrictionType {
	if o == nil || IsNil(o.Reservation) {
		var ret ReservationRestrictionType
		return ret
	}
...
// SetReservation gets a reference to the given ReservationRestrictionType and assigns it to the Reservation field.
func (o *TariffElementsRestrictions) SetReservation(v ReservationRestrictionType) {
	o.Reservation = &v
}

func (o TariffElementsRestrictions) MarshalJSON() ([]byte, error) {
...
func (o TariffElementsRestrictions) ToMap() (map[string]interface{}, error) {
...
type NullableTariffElementsRestrictions struct {
	value *TariffElementsRestrictions
	isSet bool
}

func (v NullableTariffElementsRestrictions) Get() *TariffElementsRestrictions {
	return v.value
}

func (v *NullableTariffElementsRestrictions) Set(val *TariffElementsRestrictions) {
	v.value = val
	v.isSet = true
}

func (v NullableTariffElementsRestrictions) IsSet() bool {
	return v.isSet
}

func (v *NullableTariffElementsRestrictions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTariffElementsRestrictions(val *TariffElementsRestrictions) *NullableTariffElementsRestrictions {
	return &NullableTariffElementsRestrictions{value: val, isSet: true}
}

func (v NullableTariffElementsRestrictions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTariffElementsRestrictions) UnmarshalJSON(src []byte) error {
	v.isSet = true
