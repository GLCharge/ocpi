...
// checks if the CdrResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdrResponse{}

// CdrResponse struct for CdrResponse
...
func (o CdrResponse) MarshalJSON() ([]byte, error) {
...
func (o CdrResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCdrResponse struct {
	value *CdrResponse
	isSet bool
}

func (v NullableCdrResponse) Get() *CdrResponse {
	return v.value
}

func (v *NullableCdrResponse) Set(val *CdrResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCdrResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCdrResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdrResponse(val *CdrResponse) *NullableCdrResponse {
	return &NullableCdrResponse{value: val, isSet: true}
}

func (v NullableCdrResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdrResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
