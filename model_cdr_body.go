...
// checks if the CdrBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdrBody{}

// CdrBody struct for CdrBody
type CdrBody struct {
...
// SetTariffs gets a reference to the given CdrBodyTariffs and assigns it to the Tariffs field.
...
func (o *CdrBody) GetChargingPeriods() CdrBodyChargingPeriods {
	if o == nil || IsNil(o.ChargingPeriods) {
		var ret CdrBodyChargingPeriods
		return ret
	}
...
// SetChargingPeriods gets a reference to the given CdrBodyChargingPeriods and assigns it to the ChargingPeriods field.
...
// SetSignedData gets a reference to the given CdrBodySignedData and assigns it to the SignedData field.
...
func (o CdrBody) MarshalJSON() ([]byte, error) {
...
func (o CdrBody) ToMap() (map[string]interface{}, error) {
...
type NullableCdrBody struct {
	value *CdrBody
	isSet bool
}

func (v NullableCdrBody) Get() *CdrBody {
	return v.value
}

func (v *NullableCdrBody) Set(val *CdrBody) {
	v.value = val
	v.isSet = true
}

func (v NullableCdrBody) IsSet() bool {
	return v.isSet
}

func (v *NullableCdrBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdrBody(val *CdrBody) *NullableCdrBody {
	return &NullableCdrBody{value: val, isSet: true}
}

func (v NullableCdrBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdrBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
