...
The client SDK for all OCPI 2.2.1 modules
- Versions
- Credentials
- Locations
- Sessions
...
```shell
openapi-generator generate -i api/openapi.yaml -g go -p packageName=OCPI -p packageVersion=2.2.1
```
...
```shell
import OCPI "github.com/GLCharge/ocpi"
```
