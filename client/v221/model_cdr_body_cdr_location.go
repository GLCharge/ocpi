...
// checks if the CdrBodyCdrLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdrBodyCdrLocation{}

// CdrBodyCdrLocation struct for CdrBodyCdrLocation
...
// SetCoordinates gets a reference to the given CdrBodyCdrLocationCoordinates and assigns it to the Coordinates field.
...
func (o CdrBodyCdrLocation) MarshalJSON() ([]byte, error) {
...
func (o CdrBodyCdrLocation) ToMap() (map[string]interface{}, error) {
...
type NullableCdrBodyCdrLocation struct {
	value *CdrBodyCdrLocation
	isSet bool
}

func (v NullableCdrBodyCdrLocation) Get() *CdrBodyCdrLocation {
	return v.value
}

func (v *NullableCdrBodyCdrLocation) Set(val *CdrBodyCdrLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCdrBodyCdrLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCdrBodyCdrLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdrBodyCdrLocation(val *CdrBodyCdrLocation) *NullableCdrBodyCdrLocation {
	return &NullableCdrBodyCdrLocation{value: val, isSet: true}
}

func (v NullableCdrBodyCdrLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdrBodyCdrLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
